...
public class ResumeParserProgram {
	...
	public JSONObject loadGateAndAnnie(File file, HttpServletRequest request) throws GateException, IOException {
		System.setProperty("gate.site.config", request.getSession().getServletContext().getRealPath("/resources/GATEFiles/gate.xml"));
		if (Gate.getGateHome() == null)
			Gate.setGateHome(new File(request.getSession().getServletContext().getRealPath("/resources/GATEFiles")));
		if (Gate.getPluginsHome() == null)
			Gate.setPluginsHome(new File(request.getSession().getServletContext().getRealPath("/resources/GATEFiles/plugins")));
		Gate.init();
